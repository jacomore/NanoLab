...
ax7[0].semilogx(f_part[pos],rad_to_degree(Z_phase),".",markersize =10 ,color = "red", label ="data_DAQ")
...
ax7[1].semilogx(f_part[pos],20*np.log10(Z_modulus),".", markersize = 10,color = "red", label ="data_DAQ")
